...
public class AddressController {
	...
	public PageBean search(@RequestBody TbAddress address, int page, int rows  ){
		return addressService.findPage(address, page, rows);		
	}

	@RequestMapping("/queryListByLoginUser")
	public List<TbAddress> queryListByLoginUser(){

		String username = SecurityContextHolder.getContext().getAuthentication().getName();
		return addressService.queryListByUserId(username);
