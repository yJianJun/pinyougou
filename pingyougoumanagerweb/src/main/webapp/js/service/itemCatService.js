...
app.service('itemCatService',function($http){
	...
	this.queyByParentId=function (Id) {
		return $http.get('../itemCat/queyByParentId.do?Id='+Id);
    }

    this.queryById=function (parentId) {
		return $http.get('../itemCat/queryById.do?parentId='+parentId);
    }
